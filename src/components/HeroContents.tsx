...
export default function HeroContent() {
  ...
  return (
    <>
      <div className="absolute top-0 right-0 h-full w-2/5 backdrop-blur-sm" style={{ maskImage: 'linear-gradient(to left, black 60%, transparent)' }} />
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex flex-col p-6">
            <h1 className="hero-heading">
              ...
              <motion.div className="flex justify-end" initial="hidden" animate="visible" transition={{ staggerChildren: 0.1 }}>
